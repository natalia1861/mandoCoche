...
c b 5 <td><input type=checkbox name=R OnClick="submit();" %s>R</td>
c b 4 <td><input type=checkbox name=G OnClick="submit();" %s>G</td>
c b 3 <td><input type=checkbox name=B OnClick="submit();" %s>B</td>
t <td width="5%"></td>
